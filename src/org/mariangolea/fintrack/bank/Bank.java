...
/**
 * Abstract representation of a Bank.
 *
 */
public abstract class Bank {
	 ...
	 * transactions. <br>
	 * This represents a perfect match of what the header line string looks like in
	 * a CSV report file for this bank.
	 */
	public final String relevantContentHeaderLine;
	/**
	 * Some banks add CSV content to specify the generated transactions number. <br>
	 * If a certain bank does not provide one, this field will be a empty string.
	 * <br>
	 * It represents the label that associated parser needs to look for in order to
	 * next parse the transactions number, for validation purposes.
	 */
	...
	public Bank(final Locale locale, final String relevantContentHeaderLine, final String transactionsNumberLabel,
			final DateFormat startDateFormat, final DateFormat completedDateFormat, final NumberFormat numberFormat,
			final int[] mandatoryRecordIndexes, int maxRecordSize) {
